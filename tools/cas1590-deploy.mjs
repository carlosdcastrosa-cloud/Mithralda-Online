// CAS-1590 deploy: fold the CAS-1586 increment (Aura Gélida — 5th frost affix — +
...
// version.json (build=df9d355c78e3, HEAD 0d7f24a).
//
...
const EXPECTED = new Set(["game.js", "strings.js", "sim/config.js", "sim/sim.js", "render/render.js", "version.json"]);
...
const idx = "/tmp/cas1590-ghp-index";
...
const msg = `CAS-1590: deploy Élite Campeón (rare 2-affix mini-boss + guaranteed Esencia) to gh-pages (build df9d355c78e3, HEAD ${headSha.slice(0, 7)})`;
