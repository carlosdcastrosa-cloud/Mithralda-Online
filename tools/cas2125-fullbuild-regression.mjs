...
log("");
if (ok) log(`✅ CAS-2125 HOLISTIC FULL-BUILD REGRESSION — ALL PASS (24 systems + 5 go-live + TIME-ATTACK(29) + VARIANTS(30,LIVE) + SEEDED CHALLENGE(31,LIVE) + ARENA HAZARDS(32,LIVE) + GUARD COUNTER(33,LIVE) + DODGE COUNTER(34,LIVE) + RALLY(35,LIVE) + NG_PLUS + onboarding + 7 balance + JUICE + determinism on ${EXPECT_BUILD})`);
else { console.error("❌ CAS-2125 HOLISTIC FULL-BUILD REGRESSION — FAIL"); process.exit(1); }
