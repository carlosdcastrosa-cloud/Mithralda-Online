// CAS-2114: Deploy DARK — Recuperación / Rally / Regain (mec #35).
// Overlay = sim/config.js + sim/sim.js + render/render.js. RALLY.enabled:false DARK/inert.
...
function buildAndPush() {
  ...
  const commit = gitStr("commit-tree", tree, "-p", parent, "-m",
    `CAS-2114: Deploy DARK Rally/Regain mec #35 — 3-blob overlay (sim/config.js, sim/sim.js, render/render.js), RALLY.enabled:false, reversible — build ${build}`);
  try {
