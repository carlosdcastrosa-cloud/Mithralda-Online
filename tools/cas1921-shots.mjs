...
await page.evaluate(() => { document.getElementById("nameInput").value = "QA1890"; window.dispatchEvent(new KeyboardEvent("keydown", { code: "Enter", key: "Enter", bubbles: true })); });
