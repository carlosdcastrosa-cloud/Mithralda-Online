...
function determinism() {
  ...
  if (a === b && !a.startsWith("ERR:")) pass(`[DETERM] sim cycle fingerprint identical across 2 runs (len ${a.length}) — 36 mechanics (Arena Hazards LIVE gate-closed w/o boss + Guard/Dodge Counter LIVE arm-only-on-perfect-input + Rally LIVE damage-taken pool + Riposte DARK enemy-broken-only) add 0 draws to a normal run`);
