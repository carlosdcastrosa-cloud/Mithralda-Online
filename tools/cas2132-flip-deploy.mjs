// CAS-2132 (CAS-2127): Gate CEO GO-LIVE flip — RIPOSTE.enabled false→true (config-only, 1 line).
...
function buildAndPush() {
  ...
  const commit = gitStr("commit-tree", tree, "-p", parent, "-m", `CAS-2132 (CAS-2127): GO-LIVE flip RIPOSTE enabled:true (mec #36 Riposte/Ejecución Crítica) — config-only 1-blob overlay (sim/config.js), reversible — build ${build}`);
  try {
