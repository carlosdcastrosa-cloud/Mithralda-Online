...
// (build fb00a6e03db2 / 799 files). Boots the canonical gh-pages URL, dynamically
...
//   - EXPECT_BUILD -> fb00a6e03db2 (Pilar 15 Two-Handing deploy, the latest gh-pages overlay)
...
// The live served config (build fb00a6e03db2) carries all 15 pillars; this run imports
...
const EXPECT_BUILD = "fb00a6e03db2";
...
// The 16 pillars + core knobs. `en` = the property that gates the feature (most
