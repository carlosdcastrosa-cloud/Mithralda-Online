// ===========================================================================
// CAS-1921 — LIVE holistic soak: 18 Souls-like pillars WIRED in the served build
// (build 71160e07eaab / 799 files). Boots the canonical gh-pages URL, dynamically
...
// Complements tools/playtest-live.mjs (core-loop) — this proves the 18 pillars
// didn't regress off the config in the deploy under test. PASS x2 (desktop + mobile).
//
//   node tools/cas1921-pillars-live-qa.mjs [URL]
//   default URL = https://carlosdcastrosa-cloud.github.io/Mithralda-Online/
//
// Delta vs cas1908 (16-pillar, build fb00a6e03db2):
//   - EXPECT_BUILD -> 71160e07eaab (Pilar 18 Weapon Arts deploy, the latest gh-pages overlay)
//   - +WEAPON_ARCHETYPES (#17; sig: enabled + byDefId mapa + 4 classes con muls FEEL distintos)
//   - +WEAPON_ARTS (#18; sig: enabled + key:"Semicolon" + cooldownMs>0 + 4 artes firma por arquetipo)
//   - two profiles (desktop 1280x720 dsf1 + mobile 390x844 dsf2 touch) => PASS x2 wiring.
// The live served config (build 71160e07eaab) carries all 18 pillars; this run imports
...
const EXPECT_BUILD = "71160e07eaab";
...
// The 18 pillars + core knobs. `en` = the property that gates the feature (most
