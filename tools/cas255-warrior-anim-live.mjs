// CAS-255 — full QA of warrior=Clarice on the LIVE published host.
...
try{
  ...
  await sleep(900); await page.screenshot({path:join(OUT,"cas255-classsel.png")});
  ...
  // idle
  await sleep(900); await page.screenshot({path:join(OUT,"cas255-idle.png"),clip:{x:330,y:170,width:240,height:280}});
  ...
  await page.screenshot({path:join(OUT,"cas255-walk-right.png"),clip:{x:330,y:170,width:240,height:280}});
  ...
  await page.screenshot({path:join(OUT,"cas255-walk-left.png"),clip:{x:330,y:170,width:240,height:280}});
  ...
  await page.screenshot({path:join(OUT,"cas255-attack.png"),clip:{x:330,y:170,width:240,height:280}});
  ...
  await sleep(500); await page.screenshot({path:join(OUT,"cas255-death.png")});
