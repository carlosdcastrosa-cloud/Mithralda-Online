// ===========================================================================
// CAS-1900 — LIVE regression: 14 Souls-like pillars WIRED in the served build
// (build aea6ee9ab047 / 799 files). Boots the canonical gh-pages URL, dynamically
...
//
//   node tools/cas1900-pillars-live-qa.mjs [URL]
//   default URL = https://carlosdcastrosa-cloud.github.io/Mithralda-Online/
//
// Delta vs cas1890 (13-pillar, build cff98e1e1941):
//   - EXPECT_BUILD -> aea6ee9ab047 (Pilar 14 Equip Load deploy, the latest gh-pages overlay)
//   - +ENEMY_ABILITIES (#13 habilidades especiales enemigas: lunge/slam)
//   - +EQUIP_LOAD      (#14 carga de equipo / tipos de rodada; sig: 4 bandas + mid=baseline)
//   - two profiles (desktop 1280x720 dsf1 + mobile 390x844 dsf2 touch) => PASS x2 wiring.
// NB: HEAD working tree carries a Pilar-15 TWO_HAND knob (CAS-1896, NOT yet deployed);
//     the live served config (build aea6ee9ab047) is 14 pillars only, which is exactly
//     what this run imports from the live URL. TWO_HAND is deliberately NOT asserted.
// ===========================================================================
...
const EXPECT_BUILD = "aea6ee9ab047";
