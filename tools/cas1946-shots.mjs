...
await page.evaluate(() => { document.getElementById("nameInput").value = "QA1946"; window.dispatchEvent(new KeyboardEvent("keydown", { code: "Enter", key: "Enter", bubbles: true })); });
