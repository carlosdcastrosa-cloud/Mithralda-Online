...
export const ENCOUNTER_VARIANT_SURGE = {
  enabled: false,            // DARK (EVO#76). OFF byte-neutral: rama muerta ⇒ 0 reagentes + 0 grantSocket ⇒ estado byte-idéntico al HEAD. Flip false→true SÓLO tras QA DARK PASS + CEO Gate. anti-stacking: 1 arco valida a la vez.
