...
export const ROLE_SURGE = {
  enabled: false,            // DARK — EVO#93 (CAS-2551, 35º flag candidato). Se queda false hasta el flip (CAS-255x) tras CEO Gate 1/2 byte-verify + DARK QA Gate 2/2 (2-cli 0-desync) + CEO Gate 2/2. Base master HEAD 153e82a / served c2a7ab9cf1bb (#92 BULK_SURGE LIVE).
