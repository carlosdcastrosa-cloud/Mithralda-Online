...
export const CO_FOCUS_SURGE = {
  enabled: false,            // DARK (EVO#144, camino al 86º flag). enabled:false ⇒ byte-neutral OFF (_coFocusPre=0 const inerte + seam rama muerta + h.coFocusBounty transitorio + G._coFocusParty transitoria) ⇒ world-build fingerprint = 15920977 estable. El flip false→true es un paso CTO separado (config-only 1-línea) tras las Gates.
