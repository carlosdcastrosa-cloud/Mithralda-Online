...
export const INTERRUPT_SURGE = {
  enabled: false,            // DARK — EVO#89 (CAS-2532 build). Se encenderá con el flip (CTO false→true) SÓLO tras CEO Gate 1/2 byte-verify + DARK QA Gate 2/2 (2-cli 0-desync) + CEO Gate 2/2. byte-neutral OFF: enabled:false ⇒ `_interruptPre`=0 (const inerte) + seam rama muerta ⇒ killEnemy byte-idéntico al HEAD.
