...
export const CO_CAST_SURGE = {
  enabled: false,            // DARK (EVO#146, 88º candidato — CAS-2840). enabled:false ⇒ byte-idéntico al HEAD (rama muerta: 0 fichas, 0 floater, 0 badge). Flip 1-línea false→true tras CEO Gate 1/2 + DARK QA, mirror #145 TENAZA (CAS-2837).
