...
export const SPOILS_FIELD_SURGE = {
  enabled: false,            // DARK ship (EVO#79). Gate CEO flippea false→true (config-only, reversible, mirror CAS-2043/2055/2075/2093/2473). enabled:false ⇒ `_spoilsPre`=0 + seam CÓDIGO MUERTO ⇒ byte-idéntico al HEAD. anti-stacking: 1 arco valida a la vez.
