...
export const ORBIT_SURGE = {
  enabled: false,            // DARK (EVO#116, 58º flag candidato) — CAS-2684 DARK build. NO flip hasta CEO Gate 1/2 → DARK QA → CEO Gate 2/2 → config-only 1-línea flip (CTO). Additive/dead-branch OFF ⇒ byte-neutral (killEnemy byte-idéntico al HEAD, version.json UNTOUCHED).
