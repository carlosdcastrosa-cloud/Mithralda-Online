...
export const AGGRO_PRESSURE_SURGE = {
  enabled: false,            // DARK (EVO#130, 72º flag). Byte-neutral OFF: el snapshot es LECTURA PURA; sin side-effects OFF ⇒ fp 15920977 byte-idéntico. Flip a true sólo tras CEO Gate 2/2 + DARK QA.
