...
export const RAM_SURGE = {
  enabled: false,            // DARK — EVO#98 (CAS-2580, camino al 40º flag). Gated OFF. Flip 1-línea false→true tras CEO Gate 1/2 + DARK QA Gate 2/2 + CEO Gate 2/2. Base master HEAD post-#97 / served 1504785ba734 (#97 SENTINEL_SURGE LIVE). enabled:false ⇒ TODOS los seams (kill grant + badge/VM) son código muerto ⇒ killEnemy/render byte-idénticos al HEAD.
