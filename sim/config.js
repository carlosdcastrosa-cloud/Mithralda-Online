...
export const CO_TANK_SURGE = {
  enabled: false,            // DARK (EVO#140, 82º flag) — flip false→true = paso SEPARADO del CTO (config-only 1-línea). Snapshot LECTURA PURA (0 side-effects; _coTankPre=0 const inerte + seam rama muerta + h.coTankBounty transitorio + G._coTankParty transitoria) ⇒ world-build fingerprint = 15920977 estable.
