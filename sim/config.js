...
export const SPLASH_SURGE = {
  enabled: false,            // DARK — EVO#104 (46º flag). enabled:false ⇒ `_splashPre`=0 (const inerte) + seam rama muerta ⇒ killEnemy byte-idéntico al HEAD. CEO Gate 1/2 → flip false→true tras DARK QA Gate 2/2.
