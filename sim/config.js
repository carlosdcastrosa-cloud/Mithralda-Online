...
export const HEADING_SURGE = {
  enabled: false,            // DARK — EVO#90. Byte-neutro OFF: `_headingPre`=0 (const inerte) + seam de killEnemy = rama muerta ⇒ killEnemy byte-idéntico al HEAD. El flip false→true (32º flag) va tras CEO Gate 1/2 byte-verify + DARK QA Gate 2/2 (2-cli 0-desync) + CEO Gate 2/2.
