...
export const CO_FLANK_SURGE = {
  enabled: false,            // DARK (EVO#145, 87º candidato). enabled:false ⇒ byte-neutral OFF (_coFlankPre=0 const inerte + seam rama muerta + h.coFlankBounty transitorio + G._coFlankParty transitoria) ⇒ world-build fingerprint = 15920977 estable. El flip false→true será un paso CTO separado (config-only 1-línea) tras las Gates.
