...
export const ENCIRCLE_SURGE = {
  enabled: false,            // DARK (EVO#113, 55º flag) — CAS-2669 DARK build. enabled:false ⇒ TODOS los seams (kill grant + badge/VM) son código muerto ⇒ killEnemy/render byte-idénticos al HEAD. Flip false→true SÓLO tras CEO Gate 1/2 + DARK QA Gate 2/2 + CEO Gate 2/2 (config-only 1-línea, mirror #108-#112).
