...
export const CO_FLEE_SURGE = {
  enabled: false,            // DARK (EVO#141, 83º flag) — flip false→true = paso SEPARADO del CTO (config-only 1-línea). Snapshot LECTURA PURA (0 side-effects; _coFleePre=0 const inerte + seam rama muerta + h.coFleeBounty transitorio + G._coFleeParty transitoria) ⇒ world-build fingerprint = 15920977 estable.
