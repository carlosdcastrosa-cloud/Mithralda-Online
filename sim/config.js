...
export const CARNAGE_FIELD_SURGE = {
  enabled: false,            // DARK — Gate CEO flippea live (config-only 1-línea false→true, reversible, mirror CAS-2043/2055/2075/2093/2473/2479). enabled:false ⇒ `_carnagePre`=0 + seam CÓDIGO MUERTO ⇒ byte-idéntico al HEAD. anti-stacking: 1 arco valida a la vez.
