...
export const MAELSTROM_FIELD_SURGE = {
  enabled: false,            // DARK (CAS-2493) — código presente pero muerto; OFF byte-idéntico al HEAD (seam gated + snapshot 0). Ruta: GE DARK → CEO byte-verify Gate 1/2 → DARK QA Gate 2/2 → flip config-only → 24º flag LIVE.
