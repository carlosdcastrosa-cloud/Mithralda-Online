...
export const ARENA_HAZARD_SURGE = {
  enabled: false,            // DARK (EVO#77). OFF byte-neutral: rama muerta ⇒ 0 brasas + 0 grantHazardMote ⇒ estado byte-idéntico al HEAD. Flip false→true SÓLO tras QA DARK PASS + CEO Gate. anti-stacking: 1 arco valida a la vez.
