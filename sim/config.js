...
export const ELITE_SHARE_SURGE = {
  enabled: false,            // DARK (EVO#134, 76º flag) — byte-neutral OFF: el snapshot es LECTURA PURA (0 side-effects; _eliteSharePre=0 const inerte + seam rama muerta + h.eliteShareBounty NUNCA creado + G._eliteShareParty NUNCA creada) ⇒ world-build fingerprint = 15920977 estable, version.json UNTOUCHED edf6508226ba/815.
