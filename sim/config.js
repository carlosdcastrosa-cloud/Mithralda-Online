...
export const LONGSHOT_SURGE = {
  enabled: false,            // DARK — EVO#88. Se enciende SÓLO tras: CEO Gate 1/2 byte-verify + DARK QA Gate 2/2 (2-cli 0-desync) + CEO Gate 2/2. 30º flag (Remate a Distancia). enabled:false ⇒ byte-neutral OFF (`_reachPre`=0 const inerte + seam rama muerta ⇒ killEnemy byte-idéntico al HEAD).
