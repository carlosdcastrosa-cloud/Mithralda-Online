...
export const MOB_AFFIX_DANGER = {
  enabled: false,            // DARK (EVO#74). OFF byte-neutral: rama muerta ⇒ 0 flasks + 0 grantFlask ⇒ estado byte-idéntico al HEAD. Flip false→true SÓLO tras QA DARK PASS + CEO Gate. anti-stacking: 1 arco valida a la vez.
