...
export const CO_KILL_SURGE = {
  enabled: false,            // DARK (EVO#138, 80º flag candidato) — snapshot LECTURA PURA (0 side-effects; _coKillPre=0 const inerte + seam rama muerta + h.coKillBounty transitorio + G._coKillParty transitoria) ⇒ world-build fingerprint = 15920977 estable. flip false→true = paso separado del CTO (config-only 1-línea).
