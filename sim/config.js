...
export const RECOVER_SURGE = {
  enabled: false,            // DARK — EVO#100 (CAS-2594, 42º flag build). Byte-neutro OFF: TODOS los seams (grant de kill + badge/VM) CÓDIGO MUERTO ⇒ killEnemy/render byte-idéntico al HEAD. version.json INTACTO. Flip false→true SÓLO tras CEO Gate 1/2 + DARK QA (Gate 2/2 input) + CEO Gate 2/2. Base master HEAD post-#99 / served aca8e44656c4 (#99 WINDUP_SURGE LIVE).
