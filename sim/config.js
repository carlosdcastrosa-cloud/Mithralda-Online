...
export const BLIGHT_HARVEST_SURGE = {
  enabled: false,            // DARK (EVO#83). OFF byte-neutral: `_blightPre`=0 + rama muerta ⇒ 0 esencias + 0 grantBlightHarvest ⇒ estado byte-idéntico al HEAD. Flip false→true SÓLO tras QA DARK PASS + CEO Gate. anti-stacking: 1 arco valida a la vez.
