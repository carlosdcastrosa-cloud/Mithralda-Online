...
export const ZONETIER_SURGE = {
  enabled: false,            // DARK — EVO#91 (CAS-2541, 33º flag). Se flipeará false→true SÓLO tras CEO Gate 1/2 byte-verify + DARK QA Gate 2/2 (2-cli 0-desync) + CEO Gate 2/2. Base master HEAD 5f74ef0 / served 985626b23619.
