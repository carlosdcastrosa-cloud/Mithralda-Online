...
export const CONVERGE_SURGE = {
  enabled: false,            // DARK (EVO#112, 54º flag). GATED ⇒ seam _convergePre=0 (const inerte) + rama muerta ⇒ killEnemy byte-idéntico al HEAD. Flip false→true SÓLO tras CEO Gate 1/2 + DARK QA Gate 2/2 + CEO Gate 2/2 (config-only 1-línea).
