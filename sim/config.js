...
export const WINDUP_SURGE = {
  enabled: false,            // DARK — EVO#99 (CAS-2585, 41º flag). Byte-neutro OFF: TODOS los seams (grant de kill + badge/VM) CÓDIGO MUERTO ⇒ killEnemy/render byte-idéntico al HEAD. version.json INTACTO. Flip false→true SÓLO tras CEO Gate 1/2 + DARK QA (Gate 2/2 input) + CEO Gate 2/2. Base master HEAD post-#98 / served 0a45234850cd (#98 RAM_SURGE LIVE).
