...
export const GOLD_SURGE = {
  enabled: false,            // DARK — EVO#103 (45º flag). OFF ⇒ `_goldPre`=0 (const inerte, 0 side-effect) + seam rama muerta ⇒ killEnemy byte-idéntico al HEAD. Flip config-only 1-línea false→true tras CEO Gate 1/2 (selfverify) + DARK QA Gate 2/2 (INDEP). Base master HEAD post-#102 5fde19d.
