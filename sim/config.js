...
export const BULK_SURGE = {
  enabled: false,            // DARK — EVO#92 (CAS-2546, 34º flag candidato). Flip false→true SÓLO tras CEO Gate 1/2 byte-verify + DARK QA Gate 2/2 (2-cli 0-desync). Base master HEAD 20e3a95 / served db02ca6bb457 (#91).
