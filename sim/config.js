...
export const CO_PRESENCE_SURGE = {
  enabled: false,            // DARK (EVO#137, 79º flag candidato) — snapshot LECTURA PURA (0 side-effects; _coPresencePre=0 const inerte + seam rama muerta + h.coPresenceBounty transitorio + G._coPresenceParty transitoria) ⇒ world-build fingerprint = 15920977 estable. flip false→true = paso separado del CTO (config-only 1-línea).
