...
export const SENTINEL_SURGE = {
  enabled: false,            // DARK — EVO#97 (CAS-2573, 39º flag candidato). OFF ⇒ byte-neutral vs HEAD; el flip false→true llega tras CEO Gate 1/2 + DARK QA + CEO Gate 2/2. Base master HEAD post-#96 / served ec06c1f3587b (#96 TOUGH_SURGE LIVE).
