...
export const CO_DODGE_SURGE = {
  enabled: false,            // DARK (EVO#147, 89º candidate). enabled:false ⇒ byte-neutral OFF (seam rama muerta, _coDodgePre=0 const inerte, h.coDodgeBounty NUNCA creado, G._coDodgeParty NUNCA creada, badge NO se dibuja). Flip 1-línea false→true tras CEO Gate 1/2 + DARK QA (mirror #146 CO_CAST CAS-2842).
