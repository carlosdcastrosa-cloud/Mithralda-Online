...
export const SPEED_SURGE = {
  enabled: false,            // DARK (EVO#111, 53º flag). Se voltea false→true (CAS-2661) TRAS CEO Gate 1/2 + DARK QA Gate 2/2 + CEO Gate 2/2. Config-only 1-línea. GATED ⇒ seam _speedPre=0 (const inerte) + rama muerta ⇒ killEnemy byte-idéntico al HEAD.
