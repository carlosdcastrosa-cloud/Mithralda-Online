...
export const SKIRMISH_LINE_SURGE = {
  enabled: false,            // DARK (EVO#84, CAS-2504). Rama fuente INTACTA ⇒ build byte-idéntico al HEAD previo OFF. Flip a true SÓLO tras CEO Gate 1/2 byte-verify + DARK QA Gate 2/2. 26º flag (cuando encienda). anti-stacking: 1 arco valida a la vez.
