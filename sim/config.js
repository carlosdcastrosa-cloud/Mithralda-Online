...
export const ORIENT_SURGE = {
  enabled: false,            // DARK (EVO#110, 52º flag). Se voltea a true en el LIVE flip TRAS CEO Gate 1/2 + DARK QA Gate 2/2 + CEO Gate 2/2. Config-only 1-línea. GATED ⇒ seam _orientPre=0 (const inerte) + rama muerta ⇒ killEnemy byte-idéntico al HEAD.
