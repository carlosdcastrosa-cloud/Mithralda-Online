...
export const FIRM_FOOTING = {
  enabled: false,            // DARK (EVO#70, CAS-2415) — flag PRESENTE pero OFF. NO flip live en esta tarea. Reversible 1-línea false→true tras QA DARK + CEO Gate. anti-stacking: 1 arco valida a la vez.
