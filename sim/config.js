...
export const LUNGE_SURGE = {
  enabled: false,            // DARK — EVO#101 (43º flag path). byte-neutral OFF: `_lungePre`=0 (const inerte) + rama muerta ⇒ killEnemy/render byte-idéntico al HEAD. Flip false→true SÓLO tras CEO Gate 1/2 + DARK QA Gate 2/2 (2-cli 0-desync) + CEO Gate 2/2. Base master HEAD post-#100 89b9319 / served e1d801e51573/815 (#100 RECOVER LIVE).
