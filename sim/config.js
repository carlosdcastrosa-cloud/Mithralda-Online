...
export const ZONE_EVENT_SURGE = {
  enabled: false,            // DARK (EVO#75). OFF byte-neutral: rama muerta ⇒ 0 gemas + 0 grantEventGem ⇒ estado byte-idéntico al HEAD. Flip false→true SÓLO tras QA DARK PASS + CEO Gate. anti-stacking: 1 arco valida a la vez.
