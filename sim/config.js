...
export const BLOODHARVEST_SURGE = {
  enabled: false,            // DARK — Gate CEO flips tras QA OBSERVABLE. false ⇒ byte-idéntico al HEAD (rama entera código muerto, `_bloodPre`=0, h.bloodCharges nunca se crea). Camino al 28º flag.
