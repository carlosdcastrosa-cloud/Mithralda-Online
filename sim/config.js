...
export const DISPERSE_SURGE = {
  enabled: false,            // DARK (EVO#107, 49º flag) — CAS-2640 build. Byte-neutral OFF: gated en TODO seam ⇒ killEnemy/save/fingerprint byte-idénticos al HEAD. Flip false→true = LIVE tras CEO Gate 1/2 + DARK QA + CEO Gate 2/2.
