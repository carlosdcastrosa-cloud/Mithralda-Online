...
export const CONTROL_HARVEST_SURGE = {
  enabled: false,            // DARK (EVO#85, CAS-2510). 27º flag EN CONSTRUCCIÓN. Rama fuente INTACTA ⇒ build byte-idéntico al HEAD OFF. Flip config-only 1-línea tras CEO Gate 1/2 + DARK QA Gate 2/2. anti-stacking: 1 arco valida a la vez.
