...
export const BANE_SURGE = {
  enabled: false,            // DARK (EVO#105, 47º flag). enabled:false ⇒ byte-neutral OFF: `_banePre`=0 (const inerte) + seam rama muerta ⇒ killEnemy/render byte-idéntico al HEAD. Flip false→true SÓLO tras CEO Gate 1/2 + DARK QA (Gate 2/2 input) + CEO Gate 2/2. Base master HEAD post-#104 / served 7cf773339112/815 (#104 SPLASH_SURGE LIVE).
