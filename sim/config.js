...
export const PACKHARVEST_SURGE = {
  enabled: false,            // DARK — CAS-2521 EVO#87 build. Overlay byte-neutral (enabled:false ⇒ 0 efecto, código muerto): el flip a true es un cambio de 1 línea POSTERIOR (CTO) tras CEO Gate 1/2 + DARK QA Gate 2/2. 29º flag.
