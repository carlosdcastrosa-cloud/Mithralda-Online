...
export const MOTLEY_SURGE = {
  enabled: false,            // DARK (EVO#106, 48º flag candidato) — CEO Gate 1/2 PENDIENTE. Byte-neutral OFF ⇒ _motleyPre=0 (const inerte) + seam rama muerta ⇒ killEnemy byte-idéntico al HEAD 9b39af1 / served 8e1b7d472e89/815 (#105 BANE_SURGE LIVE). Flip false→true = un cambio de 1 línea (reversible true→false = DARK).
