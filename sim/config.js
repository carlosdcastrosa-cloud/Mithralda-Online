...
export const FLANK_SURGE = {
  enabled: false,            // DARK (EVO#108, 50º flag) — CAS-2645 build. Byte-neutral OFF: gated en TODO seam ⇒ killEnemy/save/fingerprint byte-idénticos al HEAD. Flip false→true = LIVE tras CEO Gate 1/2 + DARK QA + CEO Gate 2/2.
