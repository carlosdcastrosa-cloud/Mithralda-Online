...
export const TEMPEST_SURGE = {
  enabled: false,            // DARK (EVO#68, CAS-2404) — flag presente pero OFF. NO flip live en esta task. Flip config-only false→true tras QA DARK PASS + CEO Gate. Reversible 1-línea. anti-stacking: 1 arco valida a la vez.
