...
export const ACCEL_SURGE = {
  enabled: false,            // DARK (EVO#117, 59º flag candidato) — CAS-2688 DARK build. NO flip hasta CEO Gate 1/2 → DARK QA → CEO Gate 2/2 → config-only 1-línea flip (CTO). Additive/dead-branch OFF ⇒ byte-neutral (killEnemy byte-idéntico al HEAD, accelTick NUNCA corre ⇒ 0 estado per-mob, version.json UNTOUCHED).
