...
export const AGGRO_SURROUND_SURGE = {
  enabled: false,            // DARK (EVO#129, 71º flag). enabled:false ⇒ byte-neutral OFF (funciones de lectura PURAS gated + seam rama muerta + _aggroSurroundPre=0 const inerte + badge NO despachado + h.aggroSurroundBounty NUNCA creado + party sintética G._surParty NUNCA creada ⇒ NO perturba el fingerprint). SNAPSHOT PURO (SIN ring-buffer, a diferencia de #122/#128). Flip config-only false→true tras CEO Gate 2/2.
