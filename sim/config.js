...
export const CO_STRIKE_SURGE = {
  enabled: false,            // DARK (EVO#136, 78º flag) — byte-neutral OFF: el snapshot es LECTURA PURA (0 side-effects; _coStrikePre=0 const inerte + seam rama muerta + h.coStrikeBounty NUNCA creado + G._coStrikeParty NUNCA creada) ⇒ world-build fingerprint = 15920977 estable, version.json UNTOUCHED 876e25989358/815.
