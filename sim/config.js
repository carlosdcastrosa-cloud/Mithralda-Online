...
export const DEPTH_SURGE = {
  enabled: false,            // DARK (EVO#114, 56º flag candidato) — CAS-2675 DARK build. NO flip hasta CEO Gate 1/2 → DARK QA (CAS-267x) → CEO Gate 2/2 → config-only 1-línea flip (CTO). Additive/dead-branch OFF ⇒ byte-neutral (killEnemy byte-idéntico al HEAD, version.json UNTOUCHED).
