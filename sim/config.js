...
export const CO_SUPPORT_SURGE = {
  enabled: false,            // DARK (EVO#139, 81º flag) — snapshot LECTURA PURA (0 side-effects; _coSupportPre=0 const inerte + seam rama muerta + h.coSupportBounty transitorio + G._coSupportParty transitoria) ⇒ world-build fingerprint estable. flip false→true = paso separado del CTO (config-only 1-línea).
