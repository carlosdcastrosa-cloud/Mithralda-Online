...
export const AGGRO_VIGOR_SURGE = {
  enabled: false,            // DARK (EVO#131, 73º flag). byte-neutral OFF: el snapshot es LECTURA PURA (0 side-effects OFF); fingerprint = world-build-only ⇒ fp 15920977 estable. Flip false→true tras CEO Gate 1/2+2/2 + DARK QA.
