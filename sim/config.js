...
export const MOB_TIER_SURGE = {
  enabled: false,            // DARK (EVO#133, 75º flag) — byte-neutral OFF: el snapshot es LECTURA PURA (0 side-effects); fingerprint = world-build-only ⇒ fp 15920977 estable. Flip false→true SÓLO tras CEO Gate 1/2 (byteverify) + Gate 2/2 (no-drift) + DARK QA.
