...
export const COLUMN_SURGE = {
  enabled: false,            // DARK (EVO#109, 51º flag DARK) — CAS-2650 DARK build. GATED: enabled:false ⇒ seam rama muerta (_columnPre=0 const inerte) ⇒ killEnemy byte-idéntico al HEAD. Flip false→true = LIVE (tras CEO Gate 1/2 + DARK QA + CEO Gate 2/2).
