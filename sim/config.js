...
export const AGGRO_DENSITY_SURGE = {
  enabled: false,            // DARK (EVO#126, 68º flag) — byte-neutral OFF: funciones de lectura PURAS gated + seam rama muerta + _aggroDensityPre=0 const inerte + badge NO despachado + h.aggroDensityBounty NUNCA creado + G._adParty test-scaffolding NUNCA creado. SNAPSHOT PURO (lee la aggro-table directo, SIN buffer temporal, como #121/#123/#124/#125). Flip config-only false→true tras CEO Gate 2/2.
