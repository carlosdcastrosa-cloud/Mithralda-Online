...
export const BOSS_ENRAGE_SURGE = {
  enabled: false,            // DARK (EVO#78). Flip false→true SÓLO tras QA DARK PASS + CEO Gate 1/2 & 2/2. Fase de Enfurecimiento de Jefe: forrajeo de trofeos de guerra al matar mobs mientras un jefe/campeón está ENFURECIDO. anti-stacking: 1 arco valida a la vez.
