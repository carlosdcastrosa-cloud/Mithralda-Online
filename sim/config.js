...
export const GEARCHANCE_SURGE = {
  enabled: false,            // DARK — EVO#102 (44º flag). byte-neutral OFF: `_gearPre`=0 (const inerte) + rama muerta ⇒ killEnemy/render byte-idéntico al HEAD. Flip 1-línea false→true tras CEO Gate 1/2 + DARK QA Gate 2/2. Base master HEAD post-#101 ace4dab / served fed1aac601f6/815 (#101 LUNGE LIVE).
