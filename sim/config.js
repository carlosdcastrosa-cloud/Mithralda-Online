...
export const MENACE_SURGE = {
  enabled: false,            // DARK — EVO#95 (CAS-2563, 37º flag candidato). OFF por defecto: enabled:false ⇒ TODOS los seams (kill grant + badge/VM) son código muerto ⇒ killEnemy/render byte-idénticos al HEAD. Flip false→true SÓLO tras CEO Gate 1/2 byte-verify + DARK QA Gate 2/2 + CEO Gate 2/2. Base master HEAD cfa5844 / served 3d3e8be4811b (#94 SWIFT_SURGE LIVE).
