...
export const RANK_SPREAD_SURGE = {
  enabled: false,            // DARK (EVO#135, 77º flag) — byte-neutral OFF: el snapshot es LECTURA PURA (0 side-effects; _rankSpreadPre=0 const inerte + seam rama muerta + h.rankSpreadBounty NUNCA creado + G._rankSpreadParty NUNCA creada) ⇒ world-build fingerprint = 15920977 estable, version.json UNTOUCHED 1b6b45728268/815.
