...
export const ZONE_LOOT = {
  ...
  caldera:{tier:[4,4]}, // CAS-1744 — top-tier window (mirrors abyss); the capstone's epic floor is the payoff. Static key: only referenced for kills in the caldera zone (ZONE5 ON) → RNG-neutral when OFF.
